...
def main():
    ...
    if parallel and len(selected_tasks) > 1:
        ...
        for i, (task_id, task_data) in enumerate(selected_tasks):
            ...
            result = run_task_with_retries(task_id, task_data, solutions, model, provider, output_dir, sanitize_task, sanitize_id, print_input, print_output, print_json, use_smart_router, max_reflections, task_retries)
            all_results.append(result)
